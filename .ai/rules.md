...
- Use Angular19 best practices
- Use Angular signals approach with no manual change detections
- For components, never have a huge single smart componennts. Always have one main smart parent with child dumb components to breakdown the huge component into multiple
